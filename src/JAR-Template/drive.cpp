...
void Drive::control_arcade(){
  ...
  float curved_turn = (turn*turn*turn)*0.0001;
  float curved_throttle = (throttle*throttle*throttle)*0.0001;
  DriveL.spin(fwd, to_volt(curved_throttle+curved_turn), volt);
  DriveR.spin(fwd, to_volt(curved_throttle-curved_turn), volt);
}
